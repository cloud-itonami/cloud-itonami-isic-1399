(ns nonwovenops.registry-test
  (:require [clojure.test :refer [deftest is]]
            [nonwovenops.registry :as r]))
...
(deftest missing-area-is-not-flagged-exceeded
  ...
  (is (false? (r/shipment-area-exceeded? {:area-square-meters 800.0} nil))))
...
;; ----------------------------- tensile-strength-valid? -----------------------------

(deftest typical-tensile-strength-is-valid
  (is (r/tensile-strength-valid? 0.5))
  (is (r/tensile-strength-valid? 12.0))
  (is (r/tensile-strength-valid? 250.0))
  (is (r/tensile-strength-valid? 500.0)))

(deftest zero-or-negative-tensile-strength-is-invalid
  (is (not (r/tensile-strength-valid? 0.0)))
  (is (not (r/tensile-strength-valid? -1.0))))

(deftest excessive-tensile-strength-is-invalid
  (is (not (r/tensile-strength-valid? 999999.0)))
  (is (not (r/tensile-strength-valid? 500.01))))

(deftest non-numeric-or-missing-tensile-strength-is-invalid
  (is (not (r/tensile-strength-valid? nil)))
  (is (not (r/tensile-strength-valid? "12.0"))))

;; ----------------------------- basis-weight-valid? -----------------------------

(deftest typical-basis-weight-is-valid
  (is (r/basis-weight-valid? 10.0))
  (is (r/basis-weight-valid? 150.0))
  (is (r/basis-weight-valid? 2500.0))
  (is (r/basis-weight-valid? 5000.0)))

(deftest zero-or-negative-basis-weight-is-invalid
  (is (not (r/basis-weight-valid? 0.0)))
  (is (not (r/basis-weight-valid? -1.0))))

(deftest excessive-basis-weight-is-invalid
  (is (not (r/basis-weight-valid? 999999.0)))
  (is (not (r/basis-weight-valid? 5000.01))))

(deftest non-numeric-or-missing-basis-weight-is-invalid
  (is (not (r/basis-weight-valid? nil)))
  (is (not (r/basis-weight-valid? "150.0"))))
