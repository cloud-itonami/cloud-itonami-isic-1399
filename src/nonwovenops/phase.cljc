(ns nonwovenops.phase
  "Phase 0->3 staged rollout for the nonwoven/felt technical-textiles-
  ...
  consequence (a forming-line or bonding-line maintenance window means
  production downtime, and the equipment ends up actually touched); it
  is always a human plant supervisor's call. `nonwovenops.governor`'s
  `line-operate-blocked-violations` HARD-blocks direct-operate attempts
...
(defn verdict->disposition
  "Map a Nonwoven & Technical Textiles Plant Operations Governor
