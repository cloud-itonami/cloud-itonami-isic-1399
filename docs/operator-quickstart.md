# Operator Quickstart — Manufacture of other textiles n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 1399** (`cloud-itonami-isic-1399`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1399.git
cd cloud-itonami-isic-1399
```
...
- Blueprint governor key: `nonwoven-technical-textiles-plant-operations-governor`
- Likely source path: `nonwovenops.governor.cljc`
