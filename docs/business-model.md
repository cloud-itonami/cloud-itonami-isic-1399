# Business Model: Manufacture of other textiles n.e.c.
...
## Classification
- Repository: `cloud-itonami-isic-1399` ([github.com/cloud-itonami/cloud-itonami-isic-1399](https://github.com/cloud-itonami/cloud-itonami-isic-1399))
- ISIC Rev.5: `1399` — Manufacture of other textiles n.e.c.
- Domain: `:textiles/nonwoven-technical`
- Social impact: :worker-safety :labor-standards :materials-traceability
- Actor: `:nonwoven-technical-textiles-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :textiles/nonwoven-technical — who wants
...
One managed tenant (:textiles/nonwoven-technical):
...
- Do not bypass the `:nonwoven-technical-textiles-plant-operations-governor` for production decisions.
